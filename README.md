...
[![Telegram Bot](https://img.shields.io/badge/Telegram-Try%20it-blue)](https://t.me/tlgrm_quiz_bot)
...
```bash
docker pull <dockerhub-repo>/quizbot:latest
docker run --env-file .env <dockerhub-repo>/quizbot:latest
```
...
2. Выберите часовой пояс (например, "МСК+4")
